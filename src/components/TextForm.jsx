...
export default function TextForm(props) {
  ...
  return (
    ...
    <div className="mb-3">
        ...
        <textarea className="form-control" value = {text} onChange={handleChange} style={{backgroundColor: props.mode === `dark`? `#49648c` : `white`}} id="exampleFormControlTextarea1" rows="8"></textarea>
        ...
        <button disabled = {text.length === 0} className="btn btn-primary my-2 mx-0" onClick={handleclear}>Clear Text</button>
...
<div className="container" style={{color: props.mode === `light`? `black` : `white`}}>
    ...
    <div className="container">
        ...
        <p>{0.008 * text.split(/\s+/).filter((element)=> {return element.length !== 0}).length} minutes took to read your text</p>
